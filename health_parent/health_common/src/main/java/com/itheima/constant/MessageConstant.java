...
public class MessageConstant {
    ...
    public static final String cuzs = "查询角色失败";
    public static final String cuzscg = "查询角色成功";
    public static final String xzyhcg = "新增用户成功";
    public static final String xzyhsb = "新增用户失败";
    public static final String yhmcf= "用户名重复";
    public static final String scyh= "删除用户成功";
    public static final String scyhsb= "删除用户失败";
}
